...
//     try {
//       const response = await fetch('/student/doubts', {
//         method: 'POST',
//         headers: {
...
export default function AskDoubtCard() {
  ...
  const onSubmit = async (data) => {
    ...
    const postData = { ...data, studentId };
    console.log(postData);

    try {
      const response = await fetch(`http://localhost:5050/student/doubts/${studentId}`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
      ...
      console.error('Failed to submit doubt:', error);
      setSuccessMessage("Failed to submit doubt. Please try again.");
    }
  };
    ...
    <div className="max-w-xl mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
      <div className="p-6">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          {errors.doubt && <p className="text-red-500">Field is empty</p>}
          <button type="submit" className="px-4 py-2 bg-gray-500 text-white rounded-md hover:bg-gray-600">
            Submit
          </button>
